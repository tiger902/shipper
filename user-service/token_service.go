...
var (
	// Define a secure key string used as a salt when hashing our tokens. Please make your own way more secure than this, use a randomly generated md5 hash or something
